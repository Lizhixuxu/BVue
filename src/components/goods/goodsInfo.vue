        ...
        <div class="mui-card">
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
						<swiper :swipeList="swipe" :isfull="false"></swiper>
					</div>
				</div>
			</div>
				...
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
                        ...
                        <p>
                            ...
                            <!-- 按钮属于goodsinfo页面,数字属于numberbox组件,涉及到子组件向父组件传值(事件调用机制)-->
...
export default {
    ...
    methods: {
        ...
        enter(el,done){
            el.offsetWidth;
            //小球动画优化思路：
            //影响因素有：滚动条的位置和分辨率,用domObject.getBoundingClientRect()来获取DOM元素的位置
            //获取小球在页面中的位置
